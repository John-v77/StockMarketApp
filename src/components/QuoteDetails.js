    ...
    <div>
      ...
      <div class="chart">
          ...
          >
            ...
            <Tooltip />
            <Legend  />
            <Line connectNulls={true}  isAnimationActive={false} type="monotone" dataKey="high" stroke="yellow" dot={false} />
            <Line connectNulls={true} isAnimationActive={false} type="monotone" dataKey={"low"} stroke="red" dot={false} />
          </LineChart>
      </div>
      ...
      <div class="summary-Section" style={{marginBottom:'30px'}}>
